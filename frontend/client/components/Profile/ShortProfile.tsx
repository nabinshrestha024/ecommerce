    ...
    >
      <div className="flex flex-col">
        ...
        <div className="flex flex-col items-center">
          <div className="h-20 w-20 sm:h-24 sm:w-24 relative flex justify-center items-center rounded-full bg-gray-200 shadow-md mt-1 mb-2">
            <Image
              src={data?.profilePicture}
              alt="Profile"
              fill
              className="h-full w-full absolute rounded-full object-cover border-2 border-white"
            />
          </div>
