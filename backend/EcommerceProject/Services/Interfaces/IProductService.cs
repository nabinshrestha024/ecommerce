...
namespace EcommerceProject.Services.Interfaces
{
    ...
    {
        Task<ProductCatalogResponse> GetPagedAsync(int? categoryId, string? search, List<string>? tags, decimal? minPrice, decimal? maxPrice, int page, int pageSize, CancellationToken ct);
