...
namespace EcommerceProject.Services.Interfaces
{
    ...
    {
        Task AddProductReviewAsync(int productId, int userId, CreateReviewDto dto, CancellationToken ct);
        Task<IEnumerable<ReviewDto>> GetProductReviewsAsync(int productId, CancellationToken ct);

        Task AddWebsiteReviewAsync(int userId, CreateReviewDto dto, CancellationToken ct);
